...
- 💬 Колонка «Топик Telegram» — ссылка на обсуждение букса в форуме сообщества
...
Колонки листа «Таблица»: название сайта, **топик Telegram**, дата создания, минимальная сумма вывода, сложность регистрации/вывода, платежные системы, типы работы. Топик — ссылка вида `https://t.me/c/3960409977/<id>`.
